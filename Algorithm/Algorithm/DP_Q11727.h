...
* Q11727
--------------------*/
class Q11727 final : public QBase
{
public:
	Q11727() = default;
	virtual ~Q11727() = default;
...
private:
	const std::string _dir = "./TestData/Q11727/";
private:
	std::uint16_t _N;
};
...
#if defined(DEBUG) || defined(_DEBUG)
	int TestCase = 2;
	// QHelper::SaveTest("./TestData/Q11727/", TestCase);
	std::unique_ptr<QBase> q = std::make_unique<Q11727>();
