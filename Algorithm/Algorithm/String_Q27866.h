...
* Q27866
--------------------*/
class Q27866 : public QBase
{
public:
	Q27866() = default;
	virtual ~Q27866() = default;
...
private:
	std::string _dir = "./TestData/Q27866/";
	std::string _S;
	uint16_t _N;
};
...
{
#if defined(DEBUG) || defined(_DEBUG) 
	// QHelper::SaveTest("./TestData/Q27866/", 3);
#endif
	QHelper::Init();
	std::unique_ptr<QBase> q = std::make_unique<Q27866>();
	q->Solve(3);
	return 0;
}